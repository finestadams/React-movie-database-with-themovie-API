...
import PropTypes from 'prop-types';
 ...
 const MovieDetails = ({movies, handleFavouritesClick, removeFavouriteMovie}) => {
  const {id, poster_path,original_title, title,release_date,popularity,vote_count, overview} = movies
      if(movies === undefined){
